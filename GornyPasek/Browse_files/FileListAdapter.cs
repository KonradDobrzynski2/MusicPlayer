namespace GornyPasek
{
    ...
    public class FileListAdapter : ArrayAdapter<FileSystemInfo>
    {
        ...
        public FileListAdapter(Context context, IList<FileSystemInfo> fsi)
            : base(context, Resource.Layout.BrowseFilesList, Android.Resource.Id.Text1, fsi)
        {
            _context = context;
        }
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                row = _context.GetLayoutInflater().Inflate(Resource.Layout.BrowseFilesList, parent, false);
